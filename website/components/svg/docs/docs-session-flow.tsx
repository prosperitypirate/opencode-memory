export function DocsSessionFlow() {
  return (
    <svg viewBox="0 0 680 320" width="100%" className="mx-auto w-full max-w-3xl" role="img" aria-label="The full hook flow from user message through memory retrieval, LLM call, and auto-save storage.">
      ...
      <defs>
        ...
        <style>{`
          ...
          @media (prefers-reduced-motion: no-preference) {
            ...
            .return-arc-sf { animation: dashFlowRev-sf 2s linear infinite; stroke-dasharray: 10 8; }
            @keyframes dashFlow-sf { to { stroke-dashoffset: -14; } }
            @keyframes dashFlowRev-sf { to { stroke-dashoffset: 18; } }
      ...
      <text x="235" y="112" fontSize="9" fontFamily="var(--font-mono, monospace)" className="fill-muted-foreground" textAnchor="middle">Turn 1: full fetch / Turn 2+: refresh</text>
